...
<div class="row g-4">
  <div class="col-md-5">
    <div class="card"><div class="card-header border-secondary fw-semibold small">New Field</div>
      <div class="card-body">
        <form method="POST" action="<?= url('admin/custom-fields') ?>">
          ...
          <div class="mb-2"><label class="form-label small">Variable (auto)</label><input type="text" name="variable_name" class="form-control form-control-sm" placeholder="Automatisch aus Name"></div>
        ...
        <div class="list-group-item bg-transparent border-secondary py-2 px-3">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <small class="text-muted ms-1">var: <?= e($f['variable_name']) ?></small>
            </div>
            <form method="POST" action="<?= url('admin/custom-fields/' . $f['id'] . '/delete') ?>" data-confirm="Delete field and all values?">
